...
#Esse agente é como o anterior (4), mas possui uma distância de percepção da bola ainda mais limitada.
    if (yDaBola > Y_Jogador_2 and xDaBola > 150 and xDaBola < 220):
