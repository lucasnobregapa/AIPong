...
#Esse agente calcula a distância entre ele e a bola em certo momento, e adiciona ou subtrai essa distância conforme nocessário.
    if(xDaBola > 200 and xDaBola < 201 and Y_Jogador_2 < yDaBola):
        Y_Jogador_2 = Y_Jogador_2 + abs(Y_Jogador_2-yDaBola)
    if(xDaBola > 200 and xDaBola < 201 and Y_Jogador_2 > yDaBola):
        Y_Jogador_2 = Y_Jogador_2 - abs(Y_Jogador_2-yDaBola)
