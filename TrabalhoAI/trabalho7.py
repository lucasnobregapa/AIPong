...
#Esse agente adiciona ou subtrai valores de sua posição somente quando ele ainda não alcançou a bola.
#Ele também possui a função de retornar ao centro da tela quando a bola está longe.
    if (xDaBola > 0 and xDaBola < 220 and Y_Jogador_2!=yDaBola):
        Y_Jogador_2 = Y_Jogador_2+Velocidade_Bola_X
    
    if (xDaBola < 0 and Y_Jogador_2 < 0):
