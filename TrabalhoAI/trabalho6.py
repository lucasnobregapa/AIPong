...
#Esse agente adiciona a velocidade atual da bola (positiva ou negativa) à sua própria posição, afim de alcançar a bola.
#O valor da velocidade da bola é multiplicado por '6' para ser compatível com a distância da tela.
    if (xDaBola > 200 and xDaBola < 220 and Y_Jogador_2!=yDaBola):
        Y_Jogador_2 = Y_Jogador_2+Velocidade_Bola_X*6
